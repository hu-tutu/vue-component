...
import { getCookie, setCookie, delCookie,getlocal } from "../../utils/utils";
import '../../../env'
...
axios.interceptors.request.use(function (config) {
  ...
  if (data&&data.permCode) {
    config.headers['permCode']=data.permCode,
      config.headers['permTime']=data.permTime
    delete data.permCode
    delete data.permTime
  }
